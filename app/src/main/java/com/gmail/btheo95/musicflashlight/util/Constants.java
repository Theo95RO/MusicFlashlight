...
public class Constants {
    ...
    public static final int PREFERENCE_FLASH_MODE_DEFAULT = FlashMode.TORCH;

    public static final String PREFERENCE_MUSICAL_SENSIBILITY_MODE_KEY = "preference_musical_sensibility_mode";
    public static final int PREFERENCE_MUSICAL_SENSIBILITY_MODE_DEFAULT = MusicModes.AUTO;
}
